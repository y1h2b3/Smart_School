...
class LoveAppRagCloudAdvisorConfig {
     ...
     */
    @Bean
    public DocumentRetriever localDocumentRetriever() {
     ...
     */
    @Bean
    public Advisor loveAppCompositeRagAdvisor(DocumentRetriever localDocumentRetriever,
                                              DocumentRetriever cloudDocumentRetriever) {
     ...
     */
    @Bean
    public Advisor loveAppRagCloudAdvisor(DocumentRetriever cloudDocumentRetriever) {
        return RetrievalAugmentationAdvisor.builder()
                .documentRetriever(cloudDocumentRetriever)
                .build();
    }
